--[[
    ...
    - Numeric dictionary key support
    ...
    multiSelect:
    - false or omitted = single selection
...
function MoonLib:CreateWindow(title)
    ...
    function Window:CreateTab(name)
        ...
        -- callback(selectedName, selectedId)
        --
        -- Multi-select callback:
        -- callback(selectedNames, selectedIds)
        --
        -- multiSelect:
        -- false or omitted = single-select
        -- true = multi-select
        -- "Multi" = multi-select
        function Tab:CreateDropdown(
            ...
            local selectedHoverColor = selectedColor:Lerp(
                Color3.fromRGB(255, 255, 255),
                0.1
            )
            ...
            local function updateHeader()
                ...
                elseif #selectedNames == 1 then
                    ...
                    SelectedText.Text =
                        tostring(#selectedNames) .. " selected"
                end
            end
            ...
            local function fireCallback()
                ...
                local selectedNames, selectedIds =
                    getSelectedValues()
            ...
            for index, option in ipairs(sortedOptions) do
                ...
                OptionButton.MouseEnter:Connect(function()
                    ...
                    if option.selected then
                        targetColor = selectedHoverColor
                    else
