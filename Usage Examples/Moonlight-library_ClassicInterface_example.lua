...
local MoonLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/MoonOFCC/RobloxGUI_Moonlight_Libraries/refs/heads/main/Moonlight-library_ModernInterface.lua"))()
